 ...
 * @version $Id: newsletter.php 84 2012-02-16 17:42:27Z syntaxerror.no $
 * @translation: Rune Rasmussen http://www.syntaxerror.no
 */

define('TEXT_COUNT_CUSTOMERS', 'Kunder som mottar nyhetsbrev: %s');
define('HEADING_TITLE', 'Nyhetsbrevbehandling');
...
define('TEXT_PLEASE_SELECT_AUDIENCE','Velg hvem som skal motta dette nyhetsbrevet: ');
