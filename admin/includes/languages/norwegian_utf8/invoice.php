 ...
 * @version $Id: invoice.php 107 2012-04-15 12:04:10Z syntaxerror.no $
 */
...
define('ENTRY_SOLD_TO', 'Faktureres:');
define('ENTRY_SHIP_TO', 'Leveres:');
define('ENTRY_PAYMENT_METHOD', 'Betalingsmetode:');
define('ENTRY_SUB_TOTAL', 'Totalt produkter:');
define('ENTRY_TAX', 'MVA:');
define('ENTRY_SHIPPING', 'Levering:');
define('ENTRY_TOTAL', 'Total ordresum:');
