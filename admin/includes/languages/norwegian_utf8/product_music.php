 ...
 * @version $Id: product_music.php 107 2012-04-15 12:04:10Z syntaxerror.no $
 */
...
define('TEXT_PRODUCT_DATE_ADDED', 'Dette produktet ble lagt til vår katalog %s.');
define('TEXT_PRODUCT_DATE_AVAILABLE', 'Dette produktet vil være på lager %s.');
...
define('TEXT_INFO_COPY_TO_INTRO', 'Velg en ny kategori som du ønsker å kopiere dette produket til');
...
define('TEXT_DELETE_PRODUCT_INTRO', 'Er du sikker på at du ønsker permanent å slette dette produktet?');
...
define('TEXT_MOVE_PRODUCTS_INTRO', 'Velg hvilken kategori du ønsker <b>%s</b> å være i');
define('TEXT_MOVE_CATEGORIES_INTRO', 'Velg hvilken kategori du ønsker <b>%s</b> å være i');
define('TEXT_MOVE', 'Flytt <b>%s</b> til:');

define('TEXT_NEW_CATEGORY_INTRO', 'Fyll ut følgende informasjon for ny kategori');
...
// Products and Attribute Copy Options
  define('TEXT_COPY_ATTRIBUTES_ONLY','Bare brukt på kopierte produkter ...');
  ...
  define('TEXT_COPY_MEDIA_MANAGER','Kopier alle medabehandlings-samlinger assosiert med dette produktet.');
  ...
  define('TEXT_COPY_ATTRIBUTES_DELETE','<strong>Slett</strong> først, så kopier nye varianter');
  define('TEXT_COPY_ATTRIBUTES_UPDATE','<strong>Oppdater</strong> med nye innstillinger/priser, legg så til nye');
