 ...
 * @version $Id: document_general.php 107 2012-04-15 12:04:10Z syntaxerror.no $
 */
...
define('TEXT_DOCUMENT_NAME', 'Dokumentnavn:');
define('TEXT_DOCUMENT_DETAILS', 'Dokumentinnhold:');
define('TEXT_DOCUMENT_IMAGE', 'Dokumentbilde:');
define('TEXT_DOCUMENT_IMAGE_DIR', 'Last opp til mappe:');
define('TEXT_DOCUMENT_URL', 'Dokuments nettlenke:');
define('TEXT_DOCUMENT_URL_WITHOUT_HTTP', '<small>(uten http://)</small>');
...
// meta tags
  define('TEXT_META_TAG_TITLE_INCLUDES','<strong>Marker hva dokumentets metatagg-tittel bør inneholde:</strong>');
  define('TEXT_PRODUCTS_METATAGS_PRODUCTS_NAME_STATUS','<strong>Dokumentnavn:</strong>');
