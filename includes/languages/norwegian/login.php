...
define('TEXT_LOGIN_ERROR', 'Feil: Beklager, e-postadressen og/eller passordet stemmer ikke med vår database. Vennligst prøv på nytt.');
...
define('TEXT_LOGIN_BANNED', 'Feil: Tilgang nektet.');
