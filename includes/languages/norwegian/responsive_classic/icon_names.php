...
define('ICON_TRASH_ALT', 'Slett dette produktet fra handlekurven ved å klikke dette ikonet.');
define('ICON_UPDATE_ALT', 'Endre antall ved merke nummer i feltet, endre og klikk på denne knappen.');
define('ICON_TINYCART_ALT', 'Legg dette produktet til i din handlekurv ved å klikke her.');
