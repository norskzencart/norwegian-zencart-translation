...
define('SUB_HEADING_TEXT', 'Gavekort kjøpes på samme måte som andre produkter i vår butikk. Du kan
  ...
  Når det er kjøpt, vil verdien av gavekortet bli lagt til din personlige
   gavekortbalanse. Dersom du har penger på din gavekortbalanse, vil du
...
define('SUB_HEADING_TEXT','For å sende et gavekort må du først gå til siden for sending av gavekort. Du kan
  ...
  define('SUB_HEADING_TEXT','Dersom du har penger på din gavekortbalanse, kan du bruke disse pengene på å
  kjøpe noen av våre produkter. Når du går til kassen, vil du se en ekstra boks
  komme til syne. Her skriver du inn summen du vil bruke av din gavekortbalanse.
  Vennligst vær oppmerksom på at dersom det ikke er nok penger på din gavekortbalanse, må du også oppgi en annen betalingsmåte for å dekke handelen.
  Dersom du har mer penger på din gavekortbalanse enn den totale summen for
  din ordre vil resterende beløp fortsatt være tilgjengelig på din gavekortbalanse for senere bruk.');
  break;
  case '4':
  ...
  å opprette en konto eller å logge inn dersom du allerede har konto hos oss. Til slutt blir gavekortet kontrollert og verdien blir overført til din gavekortbalanse, klar til å bli brukt på hva du vil.<br /><br />
...
og gavekortets verdi blir overført til din gavekortbalanse. Du kan nå bruke disse pengene til å handle varer hos oss');
  break;
  case '5':
