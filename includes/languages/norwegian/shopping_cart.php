...
define('OUT_OF_STOCK_CANT_CHECKOUT', 'Produkter merket med ' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' er ikke på lager, eller vi har for få til å dekke hele din ordre. Vennligst endre antall på produkter merket med (' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . '). Takk!');
define('OUT_OF_STOCK_CAN_CHECKOUT', 'Produkter merket med ' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' er ikke på lager, eller vi har for få produkter til å dekke hele din ordre. Produkter som ikke er på lager blir satt i restordre.');
