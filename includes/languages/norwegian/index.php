...
if ( ($category_depth == 'products') || (zen_check_url_get_terms()) ) {
  ...
  define('TEXT_NO_PRODUCTS', 'Vi har dessverre ingen produkter i denne kategorien for øyeblikket.');
  define('TEXT_NO_PRODUCTS2', 'Vi har dessverre ingen produkter fra denne produsenten for øyeblikket.');
