 ...
 * @version $Id: other_images_names.php 93 2012-02-16 23:01:05Z syntaxerror.no $
 */
...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Fjern dette produktvarslet.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Send meg varsel om oppdateringer på dette produktet.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Skriv en omtale om dette produktet.');
define('OTHER_CALL_FOR_PRICE_ALT', 'Ring for oppdatert pris.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Siden er for øyeblikket nede for velikehold. Velkommen tilbake senere.');
define('OTHER_TRANPARENT_ALT', '');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'Kundegodkjenning venter ...');
define('OTHER_REVIEWS_RATING_STARS_FIVE_ALT', 'Fem stjerner');
define('OTHER_REVIEWS_RATING_STARS_FOUR_ALT', 'Fire stjerner');
define('OTHER_REVIEWS_RATING_STARS_THREE_ALT', 'Tre stjerner');
define('OTHER_REVIEWS_RATING_STARS_TWO_ALT', 'To stjerner');
define('OTHER_REVIEWS_RATING_STARS_ONE_ALT', 'En stjerne');
