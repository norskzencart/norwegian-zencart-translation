...
$define = [
    ...
    'MODULE_ORDER_TOTAL_GV_HEADER' => TEXT_GV_NAMES.'/Rabattkoder',
    'MODULE_ORDER_TOTAL_GV_DESCRIPTION' => TEXT_GV_NAMES,
    'SHIPPING_NOT_INCLUDED' => ' [Ikke inkludert levering]',
    'TAX_NOT_INCLUDED' => ' [Eks. mva.]',
    'MODULE_ORDER_TOTAL_GV_USER_PROMPT' => 'Legg til beløp: ',
    'MODULE_ORDER_TOTAL_GV_TEXT_ENTER_CODE' => TEXT_GV_REDEEM,
    'TEXT_INVALID_REDEEM_AMOUNT' => 'Det virker som beløpet du har forsøkt å legge til ikke stemmer med tilgjengelig beløp i din gavekortkonto. Vennligst forsøk på nytt.',
    'MODULE_ORDER_TOTAL_GV_USER_BALANCE' => 'Tilgjengelig beløp: ',
