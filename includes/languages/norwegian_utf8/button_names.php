...
define('BUTTON_CHANGE_ADDRESS_ALT', 'Endre adresse');
define('BUTTON_CHECKOUT_ALT', 'Kasse');
define('BUTTON_CONFIRM_SEND_ALT', 'Send gavekort');
define('BUTTON_CONFIRM_ORDER_ALT', 'Bekreft ordre');
define('BUTTON_CONTINUE_ALT', 'Fortsett');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Fortsett å handle');
define('BUTTON_DELETE_ALT', 'Slett');
define('BUTTON_DELETE_SMALL_ALT', 'Slett');
define('BUTTON_DOWNLOAD_ALT', 'Last ned nå');
...
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Produktliste');
define('BUTTON_REVIEWS_ALT', 'Gå til omtaler');
define('BUTTON_SEARCH_ALT', 'Søk');
define('BUTTON_SEND_ALT', 'Send nå');
define('BUTTON_SEND_ANOTHER_ALT', 'Send nytt gavekort');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Send et gavekort');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Beregn leveringskostnad');
define('BUTTON_SOLD_OUT_ALT', 'Utsolgt');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Utsolgt');
define('BUTTON_SUBMIT_ALT', 'Send innformasjon');
define('BUTTON_UNSUBSCRIBE', 'Avmeld');
define('BUTTON_UPDATE_ALT', 'Oppdater');
define('BUTTON_VIEW_SMALL_ALT', 'Vis');
define('BUTTON_WRITE_REVIEW_ALT', 'Skriv omtale');
