...
// javascript messages
  ...
  define('ENTRY_LAST_NAME_ERROR', 'Etternavnet ditt må inneholde minst ' . ENTRY_LAST_NAME_MIN_LENGTH . ' tegn.');
  define('ENTRY_LAST_NAME_TEXT', '*');
  define('ENTRY_DATE_OF_BIRTH', 'Født:');
  define('ENTRY_DATE_OF_BIRTH_ERROR', 'Fødselsdagen din må være som følgende: DD.MM.ÅÅÅÅ (f.eks. 27.02.1982)');
  ...
  define('ENTRY_NICK_DUPLICATE_ERROR', 'Brukernavnet finnes fra før, velg et annet.');
  define('ENTRY_NICK_LENGTH_ERROR', 'Brukernavnet må inneholde minst ' . ENTRY_NICK_MIN_LENGTH . ' tegn.');
  define('ENTRY_STREET_ADDRESS', 'Adresselinje 1:');
  define('ENTRY_STREET_ADDRESS_ERROR', 'Adresselinje 1 må inneholde minst ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' tegn.');
  define('ENTRY_STREET_ADDRESS_TEXT', '*');
  define('ENTRY_SUBURB', 'Adresselinje 2:');
  define('ENTRY_SUBURB_ERROR', '');
  define('ENTRY_SUBURB_TEXT', '');
  define('ENTRY_POST_CODE', 'Postnummer:');
  define('ENTRY_POST_CODE_ERROR', 'Postnummeret må inneholde minst ' . ENTRY_POSTCODE_MIN_LENGTH . ' tegn.');
  define('ENTRY_POST_CODE_TEXT', '*');
  define('ENTRY_CITY', 'Sted:');
  define('ENTRY_CUSTOMERS_REFERRAL', 'Referansekode:');

  define('ENTRY_CITY_ERROR', 'Stedsnavn må inneholde minst ' . ENTRY_CITY_MIN_LENGTH . ' tegn.');
  ...
  define('ENTRY_PASSWORD_ERROR', 'Passordet må inneholde minst ' . ENTRY_PASSWORD_MIN_LENGTH . ' tegn.');
  define('ENTRY_PASSWORD_ERROR_NOT_MATCHING', 'Passordbekreftelsen må være samme som passordet.');
  ...
  define('ENTRY_PASSWORD_CURRENT_ERROR', 'Passordet må inneholde minst ' . ENTRY_PASSWORD_MIN_LENGTH . ' tegn.');
  define('ENTRY_PASSWORD_NEW', 'Nytt passord:');
  define('ENTRY_PASSWORD_NEW_TEXT', '*');
  define('ENTRY_PASSWORD_NEW_ERROR', 'Ditt nye passord må inneholde minst ' . ENTRY_PASSWORD_MIN_LENGTH . ' tegn.');
  define('ENTRY_PASSWORD_NEW_ERROR_NOT_MATCHING', 'Passordbekreftelsen må være samme som det nye passordet.');
...
// constants for use in zen_prev_next_display function
  ...
  define('ENTRY_AMOUNT_CHECK_ERROR', 'Du har ikke nok penger på denne kontoen til å sende dette beløpet.');
...
// iii 031104 added:  File upload error strings
  define('ERROR_FILETYPE_NOT_ALLOWED', 'Feil:  Filtypen tillates ikke.');
  define('WARNING_NO_FILE_UPLOADED', 'Advarsel:  Ingen filer er lastet opp.');
  define('SUCCESS_FILE_SAVED_SUCCESSFULLY', 'Filen ble lagret.');
...
if (SHOW_NEW_PRODUCTS_LIMIT == 0) { 
  define('TABLE_HEADING_NEW_PRODUCTS', 'Et tilfeldig utvalg av våre produkter');
  } else if (SHOW_NEW_PRODUCTS_LIMIT == 1) {
  define('TABLE_HEADING_NEW_PRODUCTS', 'Nye produkter i %s');
  } else {
  define('TABLE_HEADING_NEW_PRODUCTS', 'Et tilfeldig utvalg av våre nyeste produkter');
  } // Sjekk slutt
  define('TABLE_HEADING_UPCOMING_PRODUCTS', 'Kommende produkter');
  define('TABLE_HEADING_DATE_EXPECTED', 'Forventet ankomstdato');
  define('TABLE_HEADING_SPECIALS_INDEX', 'Våre tilbud i %s');
...
// authorization pending
  ...
  define('TEXT_AUTHORIZATION_PENDING_CHECKOUT', 'Kasse utilgjengelig - Venter på godkjenning');
